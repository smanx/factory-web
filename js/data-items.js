...
const ITEMS = {
  ...
  'rocket-ammo':      { name: '火箭弹', color: '#7a5a4a', desc: '火箭筒的弹药，爆炸造成范围伤害' },
  ...
  'steam-turbine': { name: '汽轮机', color: '#8fb8d0', desc: '消耗高温蒸汽发电，功率远高于蒸汽机（5×3）。窄边(3)中部左右两侧各有一管道出入口，蒸汽可进可出，支持多台汽轮机串接；与热交换器长边(3)中心用管道对接' },
  'heat-pipe':    { name: '导热管', color: '#d98a3a', desc: '核能的传热设备（1×1）：把核反应堆产生的热量传导到热交换器，可多根串联、沿路传输（对齐《异星工厂》Heat pipe）' },
  'heat-exchanger': { name: '热交换器', color: '#a06a4a', desc: '核能的水→蒸汽转换设备（2×3，长边3在左右、短边2在上下）：消耗导热管传来的热量，把水烧成高温蒸汽供汽轮机发电（对齐《异星工厂》Heat exchanger）。左长边(3)中部为热交换接口，右长边(3)中部出高温蒸汽，上下短边各一水口（互通）' },

...
const TECHS = {
  ...
  'mining-productivity': { name: '采矿产能', cost: { 'production-science-pack': 60 }, infinite: true, desc: '无限科技：采矿机额外产出（每级 +10%），可无限叠加（对齐《异星工厂》Mining productivity 无限科技，链条终结于 Level 4）', req: ['production'] },
  // ==== 五级科技（黄瓶：实用科学） ====
  ...
  'turbo-logistics': { name: '超速物流', cost: { 'space-science-pack': 100, 'production-science-pack': 100 }, desc: '太空时代超速物流：解锁超速传送带/地下带/分流器（4 档带，速度 7.5 格/s，为普通带 4 倍），物流终极档（对齐《异星工厂》Space Age Turbo transport belt，官方配方用钨板，需先建立太空科研与冶金学体系）', req: ['space-science', 'express', 'metallurgy'] },
  ...
  'agriculture': { name: '农业科技', cost: { 'space-science-pack': 100, 'utility-science-pack': 100 }, desc: '太空时代农业：解锁雅玛果泥/生物流/营养素/生物硫磺生物质材料链、生化炉、农业科研包，以及玉玛果人造土/玉玛果沃土（供农业塔在土壤上种植作物）（对齐《异星工厂》Space Age 农业科学），需先建立太空科研体系', req: ['space-science'] },
  'stack-inserter-tech': { name: '堆叠机械臂', cost: { 'space-science-pack': 100, 'utility-science-pack': 100, 'production-science-pack': 100 }, desc: '太空时代堆叠机械臂：把集装箱机械臂升级为堆叠机械臂（官方 Space Age Stack inserter）——一次抓取 4 个同种物品并分层叠放传送带，带 5 个过滤槽（官方配方 1 集装箱机械臂+1 处理器+2 碳纤维+10 果冻→1，数据单源化），由集装箱机械臂升级而来（官方前置 logistics3+碳纤维，此处适配为物流 III+电磁学）', req: ['logistics3', 'electromagnetics'] },
  ...
  'tree-seeding': { name: '植树造林', cost: { 'agricultural-science-pack': 100, 'space-science-pack': 100 }, desc: '太空时代植树造林（对齐《异星工厂》Space Age Tree seeding）：解锁树种（Tree seed）——由 2 木材在组装机合成树种（2s，官方 tree-seed 配方），手持树种种在草地上可重新长出一棵树，用于绿化荒原、吸收污染、恢复生态（官方前置农业科技，官方配方 2木材→1树种）', req: ['agriculture'] },
  ...
  'advanced-defense': { name: '高级防御', cost: { 'space-science-pack': 100, 'electromagnetic-science-pack': 100, 'military-science-pack': 100 }, desc: '太空时代高级防御：解锁火箭炮塔与磁轨炮塔（官方 Space Age Rocket turret / Railgun turret）。火箭炮塔发射火箭弹造成范围爆炸伤害（射程 36、最小射程 15），磁轨炮塔吃电力发射磁轨炮弹直线穿透（射程 40、单发高伤害），是终局基地防线（对齐《异星工厂》Space Age 高级炮塔，数据来自 GAME_DATA），需电磁科研与冶金学', req: ['electromagnetics', 'metallurgy'] },
  ...
  'cryogenics': { name: '低温学', cost: { 'cryogenic-science-pack': 100, 'electromagnetic-science-pack': 100 }, desc: '太空时代 Aquilo 低温学：解锁低温工厂与低温科研包，可生产氨/氟/氟酮等低温流体（官方 Space Age Cryogenic science，数据来自 GAME_DATA）。低温科研包由氟酮热液+超导体+锂板+钷素星块在低温工厂制得，是太空时代终局科技的关键科学包', req: ['electromagnetics'] },
  'scrap-recycling': { name: '废料回收', cost: { 'electromagnetic-science-pack': 100, 'space-science-pack': 100 }, desc: '太空时代 Fulgora 废料回收：解锁废料与废料回收配方（官方 Space Age Scrap 回收循环）。废料可回收成铁/铜矿石/石/煤等基础资源，构建高价值循环（数据来自 GAME_DATA），需电磁科研', req: ['electromagnetics'] },
  'molten-metal': { name: '熔融金属', cost: { 'metallurgic-science-pack': 100, 'space-science-pack': 100 }, desc: '太空时代 Vulcanus 熔融金属：解锁熔融铁/熔融铜流体配方（官方 Space Age Molten metal），由铁矿/铜矿+方解石在铸造厂熔炼成液态金属，并可浇铸成铁板/钢板/铜板/齿轮/管道/铜线/低密度结构等（官方 Casting 链，数据来自 GAME_DATA），需冶金学', req: ['metallurgy'] },
  ...
  'shooting-speed': { name: '射击速度', cost: { 'military-science-pack': 40, 'chemical-science-pack': 30 }, infinite: true, desc: '无限科技：每次研究提升玩家枪械（手枪/冲锋枪/散弹枪/战斗散弹枪）与机枪炮塔的射击速度，射击间隔缩短 10%（对齐《异星工厂》Shooting speed / Weapon shooting speed 无限科技）', req: ['military2'] },
  'artillery-shell-range': { name: '炮兵射程', cost: { 'production-science-pack': 60, 'utility-science-pack': 60, 'military-science-pack': 40 }, infinite: true, desc: '无限科技：每次研究提升炮兵连与炮兵车厢的射程 +30%，让远程火力覆盖更远（对齐《异星工厂》Artillery shell range 无限科技）', req: ['military4', 'production'] },
  'rail-productivity': { name: '铁路产能', cost: { 'production-science-pack': 60, 'utility-science-pack': 60 }, infinite: true, desc: '无限科技：每次研究提升货运车厢槽位容量 +2，列车单趟装载更多货物（对齐《异星工厂》Rail productivity 无限科技）', req: ['railways', 'production'] },
  // ==== 火车制动（对齐《异星工厂》Braking force 无限科技：强化列车制动，缩短停靠/让行等待，提升铁路吞吐）====
  'braking-force': { name: '火车制动', cost: { 'production-science-pack': 50, 'utility-science-pack': 40 }, infinite: true, desc: '无限科技：每次研究提升列车制动能力，车站停靠与信号灯让行的等待时间缩短 15%（对齐《异星工厂》Braking force 无限科技，链条终结于 Level 7）', req: ['railways', 'production'] },
  ...
  'physical-projectile-damage': { name: '投射物伤害', cost: { 'space-science-pack': 80, 'military-science-pack': 50 }, infinite: true, desc: '无限科技：每次研究提升玩家枪械与子弹（手枪/冲锋枪/散弹枪/机枪炮塔/车辆机炮等投射物）伤害 +10%（对齐《异星工厂》Physical projectile damage 无限科技，链条终结于 Level 7）', req: ['military2', 'space-science'] },
  'energy-weapons-damage': { name: '能量武器伤害', cost: { 'space-science-pack': 80, 'military-science-pack': 50 }, infinite: true, desc: '无限科技：每次研究提升激光炮塔与个人激光防御等能量武器伤害 +10%（对齐《异星工厂》Laser weapons damage / Electric weapons damage 无限科技）', req: ['laser-turrets', 'space-science'] },
...
const TRIGGER_TECHS = {
  ...
  'cryogenics': '发现阿奎洛星（Aquilo）后自动解锁低温工厂与低温科研包'
};

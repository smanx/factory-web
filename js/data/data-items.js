...
const ITEMS = {
  ...
  // ===== 玩家武器与弹药（战斗体系扩充） =====
  'pistol':          { name: '手枪',   color: '#8a8f9a', desc: '游戏初始装备，基础的单发点射武器。选中后按住空格/鼠标左键开火，消耗弹药匣' },
  'submachine-gun':  { name: '冲锋枪', color: '#6a7285', desc: '手枪的升级版，射速更快，可连发。消耗弹药匣，自动优先消耗更高级弹药（穿甲弹 / 铀弹）以提升伤害（对齐《异星工厂》SMG 弹药升级）' },
  'shotgun':         { name: '散弹枪', color: '#a07a4a', desc: '伤害高，但子弹有散射范围，近距离使用需注意可能误伤自己的工厂设施。消耗散弹枪弹' },
  'combat-shotgun':  { name: '战斗散弹枪', color: '#a05a3a', desc: '散弹枪的升级版：射速翻倍且有 20% 伤害加成。消耗穿甲散弹枪弹（对齐《异星工厂》Combat shotgun）' },
  ...
  'rocket-launcher': { name: '火箭筒', color: '#5a7a4a', desc: '游戏中伤害最高的手持武器，射程极远。可装备爆破火箭弹，对成群敌人效果显著' },
  'grenade':         { name: '手雷',   color: '#4a7a3a', desc: '投掷类范围武器，用鼠标左键朝目标方向投掷，对范围敌人造成伤害' },
  ...
  'flamethrower':    { name: '火焰喷射器', color: '#a05a2a', desc: '喷射火焰进行范围持续伤害，其伤害类型可无视敌人所有抗性。消耗火焰弹药（由化工厂用轻油/重油制造）' },
  ...
  'teslagun': { name: '特斯拉电枪', color: '#5a8ae0', mark: 'Tg', desc: '太空时代 Fulgora 电能武器：由钬板+超导体+塑料+电解液在电磁工厂制得，可手持射击释放连锁电弧（官方 Tesla gun，数据来自 GAME_DATA）' },
  ...
  'pentapod-egg': { name: '五足虫卵', color: '#b06a5a', mark: '虫蛋', desc: '太空时代 Gleba 星球高级生物资源（堆叠 20）：由生化炉培育繁殖产出，击杀 Gleba 五足虫亦有概率掉落，是农业科研包与生化炉的官方原料（对齐《异星工厂》Space Age Pentapod egg，官方配方 1虫蛋+30营养素+60水→2虫蛋，堆叠 20）' },
  ...
  'foundation': { name: '平台基座', color: '#7c8490', mark: 'FD', desc: '太空平台走行地板（太空时代）：铺成空间平台可走行地面（对齐官方 Foundation，钨板+锂板+碳纤维+氟酮冷合成）' },
  'ice-platform': { name: '冰面平台', color: '#b8d4e8', mark: 'IC', desc: '冰原地表（太空时代 Aquilo）：玄冥星冰层铺装，可走行（对齐官方 Ice platform，氨水+冰合成）' },

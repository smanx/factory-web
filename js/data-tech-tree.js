...
const TECHS = {
  ...
  'railgun-defense': { name: '轨道炮防御', cost: { 'cryogenic-science-pack': 100, 'electromagnetic-science-pack': 100, 'military-science-pack': 100 }, desc: '太空时代终局防御：解锁量子处理器、轨道炮、轨道炮弹与轨道炮塔、火箭炮塔（官方 Space Age Railgun / Rocket turret 科技）。轨道炮发射贯穿线伤的高伤害攻击，火箭炮塔发射火箭弹，是太空时代最强防御体系（数据来自 GAME_DATA），需低温学与电磁科研', req: ['cryogenics', 'electromagnetics'] },
